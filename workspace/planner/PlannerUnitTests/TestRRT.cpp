...
#include "/root/workspace/src/planner/RRTConnect/RRTConnect.hpp"
#include "/root/workspace/src/planner/RRTConnect/RRTConPlannerOptions.h"
...
{   
    ...
    rplUnSignedInt dim = RRTPlanner.getDim();
...
{   
    ...
    bool isSolved = RRTPlanner.solve(qRandom, qRandom);
...
///////////////////////////////////////
// Test No 3 RRT path Finding when start and goals are different
...
{   
    ...
    bool isSolved = RRTPlanner.solve(qRandom, qRandom2);
    EXPECT_EQ(isSolved,true);
}


///////////////////////////////////////
// Test No 4 RRT-Connect path Finding when start and goals are different

rplTest(TestRRTPlanner, TestRRTConnectFindPathRandomNodes)
{   
    
    auto plannerOptions = cpproboplan::planner::RRTConPlannerOptions{}; ///< Planner configuration
    plannerOptions.max_connection_dist = 0.9;
    cpproboplan::planner::RRTConnect RRTPlanner = cpproboplan::planner::RRTConnect(spaceType, model, collision_model, plannerOptions);
