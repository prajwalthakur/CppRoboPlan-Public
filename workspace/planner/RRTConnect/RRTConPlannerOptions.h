...
namespace cpproboplan::planner
{
    ...
    public:
         ...
         * @param postProcess_
         */
        RRTConPlannerOptions(
            double max_step_size_ = 0.05,
            double max_connection_dist_ = 0.4,
            ...
            double collision_safety_margin_ = 0.02,
